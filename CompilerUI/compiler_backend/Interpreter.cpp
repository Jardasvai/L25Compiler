...
void Interpreter::listCode(int cx0)
{
    if (listswitch)
    {
        ...
        for (int i = cx0; i < cx; ++i)
        {
            ...
            fcode_stream << " " << code[i].l << " " << code[i].a << endl;
            fas_stream << " " << code[i].l << " " << code[i].a << endl;
        }
    }
}
...
void Interpreter::interpret()
{
    int p, b, t;
    cout << "Start L25" << endl;
    fresult_stream << "Start L25" << endl;
    fas_stream << "Start L25" << endl;
    ...
    while (p < cx)
    {
        ...
        case OPR:
            ...
            case 14:
            {
                ...
                if (v >= STRING_CONSTANT_BASE && v <= STRING_HEAP_MAX)
                {
                    ...
                    while (s[addr] != 0)
                    {
                        ...
                        fresult_stream << static_cast<char>(s[addr]);
                        fas_stream << static_cast<char>(s[addr]);
                        addr++;
                    }
                }
                else
            ...
            case 16:
                ...
                (*g_inputStream) >> s[t];
                fas_stream << s[t] << endl;
                fresult_stream << s[t] << endl; // 记录输入的值
                break;
            case 17:
            {
                int num = s[t];
        ...
        case WRT:
        {
            ...
            else
            {
                ...
                fresult_stream << v; // It's a number
                fas_stream << v;
            }
        }
        break;
